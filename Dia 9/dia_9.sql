...
begin;
savepoint PreValidacion; -- estado prevalidacion
insert into AsignacionesDeProyecto();
insert into AsignacionesDeProyecto();
-- validar la cantidad de horas

-- si todo sale muy bien;
commit;

-- si el total excede, podemos revertit a nuestro save point
rollback to PreValidacion;


-- procedimiento almacenado + transacciones
